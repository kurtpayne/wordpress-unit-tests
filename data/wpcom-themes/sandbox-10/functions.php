...
function sandbox_widgets_init() {
	...
	wp_register_sidebar_widget('search', __('Search', 'sandbox'), 'widget_sandbox_search', 'classname=search');
	unregister_widget('WP_Widget_Meta');
	wp_register_sidebar_widget('meta', __('Meta', 'sandbox'), 'widget_sandbox_meta', 'classname=meta');
	wp_register_sidebar_widget('rss-links', __('RSS Links', 'sandbox'), 'widget_sandbox_rsslinks', 'classname=rss-links');
	wp_register_widget_control('rss-links', __('RSS Links', 'sandbox'), 'widget_sandbox_rsslinks_control', 'height=90');
}
