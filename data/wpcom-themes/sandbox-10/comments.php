...
function sandbox_10_comment($comment, $args, $depth) {
...
<?php $sandbox_comment_alt = 0 ?>
	...
	<div id="comments-list" class="comments">
		...
		<ol>
		<?php wp_list_comments(array('callback'=>'sandbox_10_comment', 'type'=>'comment')); ?>
		</ol>
...
<?php $sandbox_comment_alt = 0 ?>
				...
				<div id="trackbacks-list" class="comments">
					...
					<ol>
					<?php wp_list_comments(array('callback'=>'sandbox_10_ping', 'type'=>'pings')); ?>
					</ol>
