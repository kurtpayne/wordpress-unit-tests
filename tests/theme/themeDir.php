...
class Tests_Theme_ThemeDir extends WP_UnitTestCase {
	...
	function test_theme_default() {
		...
		$this->assertEquals( '<a href="http://binarybonsai.com/" title="Visit author homepage" target="_blank">Michael Heilemann</a>', $theme['Author'] );
	...
	function test_theme_stylesheet_only() {
		...
		$this->assertEquals( '<a href="http://www.example.com/" title="Visit author homepage" target="_blank">Henry Crun</a>', $theme['Author'] );
	...
	function test_get_theme_data_top_level() {
		...
		$this->assertEquals( '<a href="http://example.com/" title="Visit author homepage" target="_blank">Minnie Bannister</a>', $theme_data['Author'] );
	...
	function test_get_theme_data_subdir() {
		...
		$this->assertEquals( '<a href="http://wordpress.org/" title="Visit author homepage" target="_blank">Mr. WordPress</a>', $theme_data['Author'] );
