...
class Tests_Admin_includesPlugin extends WP_UnitTestCase {
	function test_get_plugin_data() {
		...
		$default_headers = array(
			'Name' => 'Hello Dolly',
			'Title' => '<a href="http://wordpress.org/#" title="Visit plugin homepage" target="_blank">Hello Dolly</a>',
			...
			'Author' => '<a href="http://ma.tt/" title="Visit author homepage" target="_blank">Matt Mullenweg</a>',
